...
//    ELECHOUSE_cc1101.setMHZ(464);   // set basic frequency(default = 433.92)460
...
//void loop() {
//
////Transmitt "I am here" from char format.
//ELECHOUSE_cc1101.SendData(message_char, 100);
//delay(2000);
//}
...
//by Little_S@tan
#include <ELECHOUSE_CC1101_SRC_DRV.h>
//66,121,116,101,32,77,101,115,115,97,103,101
byte transmitt_byte[12] = {66,121,116,101,32,77,101,115,115,97,103,101};
char *transmitt_char = "Team 40: Radio Signal Message";
...
ELECHOUSE_cc1101.SendData(transmitt_byte, 12, 100);
delay(2000);
...
ELECHOUSE_cc1101.SendData("Direct Char Message", 100);
delay(2000);
}
